...
describe('calculateTotalCost', () => {
  ...
  test('should throw an error for invalid inputs', () => {
    expect(() => calculateTotalCost('invalid' as unknown as number, 50)).toThrow(
      'Invalid input: Both paintCost and laborCost should be numbers.'
    );
    expect(() => calculateTotalCost(100, 'invalid' as unknown as number)).toThrow(
      'Invalid input: Both paintCost and laborCost should be numbers.'
    );
  });
});
